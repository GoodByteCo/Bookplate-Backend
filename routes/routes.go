...
func GetLiked(w http.ResponseWriter, r *http.Request) {
	...
	profile := utils.GetBookList(reader, "liked")
	js, err := ffjson.Marshal(profile)
	if err != nil {
		fmt.Println(err)
	}
...
func GetRead(w http.ResponseWriter, r *http.Request) {
	...
	profile := utils.GetBookList(reader, "read")
	js, err := ffjson.Marshal(profile)
	if err != nil {
		fmt.Println(err)
	}
...
func GetToRead(w http.ResponseWriter, r *http.Request) {
	...
	profile := utils.GetBookList(reader, "to_read")
	js, err := ffjson.Marshal(profile)
	if err != nil {
		fmt.Println(err)
	}
...
func GetLibrary(w http.ResponseWriter, r *http.Request) {
	...
	profile := utils.GetBookList(reader, "library")
	js, err := ffjson.Marshal(profile)
	if err != nil {
		fmt.Println(err)
	}
